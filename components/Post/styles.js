...
const PostContainer = styled.div`
  .post {
    ...
    &__cta {
      ...
      .post__like.secondary,
      .post__comment.secondary {
        margin-right: 10px;
        font-size: 1.2rem;
        @media (min-width: ${theme.breakpoints.sm}) {
          margin-right: 15%;
      ...
      .post__like-img {
        ...
        &:hover {
          filter: brightness(0) saturate(100%) invert(65%) sepia(64%)
            saturate(2665%) hue-rotate(307deg) brightness(101%) contrast(99%);
        }
      }
      ...
      .post__comment-img {
        ...
        &:hover {
          filter: brightness(0) saturate(100%) invert(71%) sepia(6%)
            saturate(640%) hue-rotate(274deg) brightness(100%) contrast(90%);
        }
      }
    }
  }
